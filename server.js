...
/* -------------------- Routen -------------------------------------------- */
// Geschützte Tool-Endpunkte (nur mit tool-secret)
...
// Optionaler Dispatcher für /retell/tool
...
// Öffentliche Route (kein tool-secret nötig) – für Retell-Flow
app.post("/retell/public/check_availability", (req, res) => {
  try {
    res.json(computeCheckAvailability(req.body));
  } catch (e) {
